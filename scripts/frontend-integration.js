 ...
 * This file demonstrates how to integrate Hardhatforge with a web frontend
 */

// For React/Vue/Angular applications
export class HardhatforgeClient {
    ...
    useEffect(() => {
        async function init() {
            try {
                ...
                const contractClient = new HardhatforgeClient(provider, contractAddress);
