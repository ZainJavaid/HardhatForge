...
const contractABI = require("../artifacts/contracts/Hardhatforge.sol/Hardhatforge.json").abi;

program
    .name("hardhatforge-cli")
    .description("CLI tool for Hardhatforge smart contract")
    .version("1.0.0");
